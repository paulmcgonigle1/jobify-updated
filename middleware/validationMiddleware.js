...
const withValidationErrors = (validateValues) => {
    ...
    if(!errors.isEmpty()){
      ...
      if(errorMessages[0].startsWith('not authorized')){
        throw new UnauthorizedError('not authorized to access thiis')
      }
...
//really important stuff as it cleans up code for the jobController which is much less overwhelmng
...
export const validateLoginInput = withValidationErrors([
 ...
 export const validateIdParam = withValidationErrors([
  param('id').custom(async (value, {req}) => {
    ...
    if (!isAdmin && !isOwner) throw new UnauthorizedError('not authorized to access this!')
  })
 ])
